...
python evaluation_replace_bn_mean_std.py \
    ...
    # --checkpoint_file log_files/pgd_default-baselineexperiment-Madry_loss/pgd_default-baselineexperiment-Madry_loss-Madry_loss--epochs_110-weight_decay_0.0005-lr_max_0.1-epsilon_0.03137254901960784-num_steps_10-step_size_0.00784313725490196-seed_0-/20220125162740_178cxpoz/modle-epoch110.pt
